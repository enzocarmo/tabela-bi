...
.ag-theme-quartz {
  ...
  --ag-header-column-border-height: var(
  ...
  --ag-drag-ghost-border: var(
    --ag-inherited-drag-ghost-border,
    solid 1px var(--ag-border-color)
  );
  --ag-drag-ghost-shadow: var(
    --ag-inherited-drag-ghost-shadow,
    var(--ag-popup-shadow)
  );
  --ag-focus-shadow: var(
  ...
  --ag-toggle-button-border-width: var(
    --ag-inherited-toggle-button-border-width,
    2px
  );
